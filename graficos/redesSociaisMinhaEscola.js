...
const data = [{values: valores,labels: labels,type: 'pie',textinfo: 'label+percent'}]
...
title: {text: 'Redes sociais que as pessoas da minha escola mais gostam',x: 0,font: {color: getCSS('--primary-color'),family: getCSS('--font'),size: 30}},
legend: {
font: {
